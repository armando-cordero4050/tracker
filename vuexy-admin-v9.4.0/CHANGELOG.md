...
- We have updated Vuexy HTML (Bootstrap 5) with new structure and documentation. Older Bootstrap 5 version is deprecated. Upcoming Vuexy Laravel and .NET Core will use the same new structure.
