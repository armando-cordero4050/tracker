...
[View Demo](https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/landing/) //! ask

## Installation ⚒️

Installing Node & Gulp and running it is super easy in Vuexy, please follow these steps and you should be ready to rock 🤘
[Installation Steps](https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/documentation/net-core-init-installation.html)
...
1. In order to raise the GitHub issue, you must have our Premium Item repository access. [Get repo access](https://pixinvent.com/tools/github/github-access)
2. Make sure you use our [Raise Support](https://pixinvent.ticksy.com/) form to create an issue.
